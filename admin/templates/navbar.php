<header>
  ...
  <nav class="navbar navbar-expand-lg fixed-top" data-bs-theme="dark">
    ...
    <a class="border-bottom border-black border-2 mx-2" href="index.php?notepad" data-toggle="tooltip" data-placement="bottom" title="Notes"><i class="fa fa-sticky-note mx-2"> </i>Notes</a>
