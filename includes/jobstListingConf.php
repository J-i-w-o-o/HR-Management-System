...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['delete'])) {
        ...
        if ($index !== -1) {
            ...
            // Redirect back to the page with success alert
            header('Location: ../admin/index.php?job-listing&success=Job deleted successfully');
            exit();
        }
        ...
        if ($index !== -1) {
            ...
            // Redirect back to the page with success alert
            header('Location: ../admin/index.php?job-listing&success=Job updated successfully');
            exit();
        }
        ...
        // Redirect back to the page with success alert
        header('Location: ../admin/index.php?job-listing&success=Job added successfully');
        exit();
    } else {
        // Redirect back to the page with error alert
        header('Location: ../admin/index.php?job-listing&error=Invalid request');
        exit();
    }
} else {
    // Redirect back to the page with error alert
